                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="product__details__pic">
                                <div class="product__details__pic__item">
                                    <img class="product__details__pic__item--large" src="{{ asset('template/gambar_barang/' . $product->gambar_barang) }}">
                                </div>
    ...
    $halfStar = $averageRating - $fullStars >= 0.5;
                                ...
                                <ul>
                                    <li><b>Availability</b> <span>
                                            @if($product->main_stok >= 5)
                                                Available
                                            @elseif($product->main_stok > 0 && $product->main_stok < 5)
                                                Limited Stock
                                            @else
                                                Out of Stock
                                            @endif
                                                ...
                                                <!-- Add Review Form -->
                                                    <div class="mb-4 p-4 bg-light rounded">
                                                        ...
                                                        <form id="reviewForm" action="{{ route('store-review') }}" method="POST">
                                                            ...
                                                            <div class="mb-3">
                                                                <label class="form-label me-2 mb-0">Your Name: </label>
                                                                <span class="text-secondary">
                                                                    {{ Auth::user()->name }}
                                                                </span>
                                                            </div>
                        ...
                        @foreach($relatedProducts as $related)
                             <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="{{ asset('template/gambar_barang/' . $product->gambar_barang) }}">
