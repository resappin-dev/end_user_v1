            ...
            <div class="row g-0">
                ...
                <div class="col-md-7 bg-white">
                    <div class="card-body p-5">
                        ...
                        <p class="text-secondary text-center mb-4">Enter your email address to reset your password</p>
                        ...
                        <form action="/forgot-verify" method="post">
                            ...
                            <button type="submit" class="btn btn-reset w-100 py-2 mb-3">SEND RESET LINK</button>

                            <div class="text-center">
                                <a href="/login" class="text-decoration-none" style="color: #7FAD39;">
